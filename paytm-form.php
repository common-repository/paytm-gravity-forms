 ...
 * Description: This plugin allows you to accept payments using Paytm. After setup configuration with Payment Form. he will redirect to Paytm website to complete his transaction and on completion his payment,  paytm will send that user back to your website along with transactions details. This plugin uses server-to-server verification to add an additional security layer for validating transactions. Admin can also see payment status for form entries by navigating to Forms > Entries from the menu in admin.
 * Version: 1.0
 * Author: Paytm
 * Author URI: http://paywithpaytm.com/
 * Tags: Paytm, Paytm Payments, PayWithPaytm, Paytm Gravity Forms, Paytm Plugin, Paytm Payment Gateway
...
if(!empty(sanitize_text_field($_GET['resp_msg']))){
    add_action('the_content', 'paytmShowMessage');
}

 function paytmShowMessage($content){
    return '<div class="box '.htmlentities(sanitize_text_field($_GET['type'])).'-box">'.htmlentities(urldecode(sanitize_text_field($_GET['resp_msg']))).'</div>'.$content;
}
...
class GFPaytmForm {
    ...
    public static function init(){
        ...
        add_filter( 'gform_validation', 'amount_validation_method' );

        //Add Promocode validation
        add_filter( 'gform_validation', 'promocode_validation_method' );
    }
    ...
    public static function settings_page(){
        ...
        if(rgpost("uninstall")){
            ...
            $settings = array(  
                ...
                "paytm_promo_code_status"  => rgpost("gf_paytm_form_promo_code_status"),
                "paytm_promo_code_validation" => rgpost("gf_paytm_form_promo_code_validation"),
                "paytm_promo_codes"        => rgpost("gf_paytm_form_promo_codes")
            );
            ...
            <table class="form-table">
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Merchant Id Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Merchant Secret Key Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Website Name Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Industry Type Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Channel ID Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Transaction URL Provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Transaction Status URL provided by Paytm.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Enable this if you want to change Default Paytm Callback URL.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Enter Custom Callback URL.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="88%">
                        ...
                        <br/>
                        <i><?php _e("Please Select Page That You Want to Display After Payment.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
 
                <tr style="border-top: 1px solid #000;">
                    <th scope="row" nowrap="nowrap"><label for="gf_paytm_form_promo_code_status"><?php _e("Promo Code Status", "gravityforms_paytm_form"); ?></label> </th>
                    <td width="88%">
                        <select name="gf_paytm_form_promo_code_status">
                        <?php if(rgar($settings, 'paytm_promo_code_status') == 1){?>
                        ...
                        <br/>
                        <i><?php _e("Enabling this will show Promo Code field at Checkout.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
                <tr>
                    <th scope="row" nowrap="nowrap"><label for="gf_paytm_form_promo_code_validation"><?php _e("Local Validation", "gravityforms_paytm_form"); ?></label> </th>
                    <td width="88%">
                        <select name="gf_paytm_form_promo_code_validation">
                        <?php if(rgar($settings, 'paytm_promo_code_validation') == 1){?>
                            <option value="0">Disabled</option>
                            <option value="1" selected>Enabled</option>
                        <?php }else{?>
                            <option value="0" selected>Disabled</option>
                        ...
                        <br/>
                        <i><?php _e("Transaction will be failed in case of Promo Code failure at Paytm's end.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
 
                <tr>
                    <th scope="row" nowrap="nowrap"><label for="gf_paytm_form_promo_codes"><?php _e("Promo Codes", "gravityforms_paytm_form"); ?></label> </th>
                    <td width="88%">
                        <input class="size-1" id="gf_paytm_form_promo_codes" name="gf_paytm_form_promo_codes" value="<?php echo esc_attr(rgar($settings,"paytm_promo_codes")) ?>" />
                        <br/>
                        <i><?php _e("Use comma ( , ) to separate multiple codes i.e. FB50,CASHBACK10 etc.", "gravityforms_paytm_form"); ?></i>
                    </td>
                </tr>
    ...
    public static function get_active_config($form){
     ...
     public static function send_to_paytm_form($confirmation, $form, $entry, $ajax){
      ...
      if(!$config){
        ...
        $orderid = empty($invoice_id) ? $red : $invoice_id;
        ...
        $orderid = date("YmdHis") . "_" . $orderid; // for testing purpose
        ...
        if(!empty($promocode)){
            $paytm_arg['PROMO_CAMP_ID']     = $promocode;
        }


        $ids_query = "&hash=" . wp_hash("ids={$form_id}|{$lead_id}");

        $paytm_arg['CALLBACK_URL'] =  add_query_arg("gf_paytm_form_return", base64_encode($ids_query), $paytm_arg['CALLBACK_URL']);
        
 
        $paytm_arg['CHECKSUMHASH'] =  PaytmPayment::getChecksumFromArray($paytm_arg,$paytm_key);
        ...
        list($vv,$orderid) = explode("_", $orderid); // for testing purpose

        RGFormsModel::add_note($entry["id"], $user_id, $user_name, sprintf(__("Payment has been initiated. Amount: %s. Transaction Id: %s", "gravityforms"), GFCommon::to_money($paytm_arg['TXN_AMOUNT'], $entry["currency"]), $orderid));        
                
            $confirmation = '<h1 align="center">Please do not refresh this page...</h1><form action="'.$paytm_transaction_url.'" method="post" id="paytm_payment_form" name="paytm_payment_form" style="display:none;">
    ...
    public static function maybe_thankyou_page(){
        if(!self::is_gravityforms_supported())
        return;
        $gf_paytm_form_return = sanitize_text_field($_GET['gf_paytm_form_return']);
        ...
        $paytmChecksum = (!empty(sanitize_text_field($_POST["CHECKSUMHASH"]))) ? sanitize_text_field($_POST["CHECKSUMHASH"]) : ""; //Sent by Paytm pg

        $entry_id = $paramList['ORDERID'];
        list($vv,$entry_id) = explode("_", $entry_id); // for testing purpose

        if(!empty($paramList['RESPCODE']) && !empty($paramList['ORDERID']) && isset($gf_paytm_form_return)){

            if($paramList['RESPCODE'] == '01') { // success	
            $isValidChecksum = PaytmPayment::verifychecksum_e($paramList, $paytm_key, $paytmChecksum);
            ...
            if($isValidChecksum == true){
                ...
                $requestParamList["ORDERID"] = $paramList["ORDERID"]; // just for testing

                $requestParamList['CHECKSUMHASH'] = PaytmPayment::getChecksumFromArray($requestParamList, $settings['paytm_key']);
 
                $responseParamList = PaytmPayment::callNewAPI($settings['paytm_transaction_status_url'], $requestParamList);
                ...
                if($responseParamList['STATUS'] == 'TXN_SUCCESS' 
                    && $responseParamList['TXNAMOUNT'] == $paramList['TXNAMOUNT']) {
                        $payment_status = "SUCCESS";
                        $resp_msg = "Thank you for your order. Your transaction has been successful.";
                    }else{
                        $resp_msg = "It seems some issue in server to server communication. Kindly connect with administrator.";
                        $payment_status = "FAILED";
                    }
                $cancel = apply_filters("gform_paytm_form_pre_ipn", false, $paramList, $entry, $config);

                if(!$cancel) {
                    self::log_debug("Setting payment status...");
                    self::set_payment_status($config, $entry, $payment_status, $entry_id, null, $paramList['TXNAMOUNT'] );
                }
                else{
                    ...
                    $resp_msg = 'Transaction Failed Invalid Checksum';
                }
            }else{
                $resp_msg = "Thank You. However, the transaction has been Failed For Reason: " . $paramList['RESPMSG'];
            }

            $redirect_url = get_permalink( rgar($settings, 'paytm_return_page'));
     
            $redirect_url =  add_query_arg("resp_msg", urlencode($resp_msg), $redirect_url);
        ...
        switch($status){
        	case "SUCCESS" :
                ...
                if($entry["payment_status"] != "Success"){
                        ...
                        self::update_lead($entry,$entry['id']);
            ...
            case "FAILED" :
                ...
                if($entry["payment_status"] != "Failed"){
                	if(empty($entry["transaction_type"])){
                        ...
                        RGFormsModel::update_lead($entry,$entry['id']);
					}
    ...
    private static function update_lead($entry, $id){
        if(!empty($entry)){
            foreach ($entry as $entry_key => $entry_value) {
                if(is_numeric($entry_key) || $entry_key == 'id')continue;
                RGFormsModel::update_lead_property($id, $entry_key, $entry_value);
            }
        }
    }
    ...
    private static function is_valid_initial_payment_amount($config, $lead){
        ...
        $payment_amount = sanitize_text_field($_POST['TXN_AMOUNT']);
    ...
    public static function get_customer_fields(){
        ...
        if($settings['paytm_promo_code_status']==1){
            $data[] = array("name" => "promocode", "label" =>"Promocode" );
        }
...
function rgpost($name, $do_stripslashes=true){
    if(isset($_POST[$name]))
        return $do_stripslashes ? stripslashes_deep(sanitize_text_field($_POST[$name])) : sanitize_text_field($_POST[$name]);
...
// Add filter for Amount Validation
function amount_validation_method( $validation_result ) {
    ...
    foreach(GFPaytmForm::get_customer_fields() as $field){
            if( $field["name"] == "amount" ){
                  $field_id = $config[0]["meta"]["customer_fields"][$field["name"]];
                  $amount = rgpost( 'input_'.$field_id );
    ...
    if ( !$amount_validation ) {
        ...
        foreach( $form['fields'] as &$field ) {
            if ( $field->id == $field_id ) {
                ...
                $field->validation_message = 'This amount is invalid!';
                break;
            }
        }
    }
...
// Add filter for Promocode Validation
function promocode_validation_method( $validation_result ) {
    $form               = $validation_result['form'];
    $settings           = get_option("gf_paytm_form_settings");
    $paytm_promo_code_status = $settings['paytm_promo_code_status'];
    $paytm_promo_code_validation = $settings['paytm_promo_code_validation'];
    

    $config = GFPaytmFormData::get_feed_by_form($form["id"]);

    $check_promo_validation = false;
    $field_id = '';
    foreach(GFPaytmForm::get_customer_fields() as $field){
            if( $field["name"] == "promocode" ){
                  $field_id = $config[0]["meta"]["customer_fields"][$field["name"]];
                  $check_promo_validation = true;
                  break;
            }
        
    }
    $promocode = rgpost( 'input_'.$field_id );
    if($check_promo_validation && !empty($promocode) && $paytm_promo_code_validation){


        //match with promode code input
        $promo_codes = explode(",", $settings["paytm_promo_codes"]);

        $promo_code_found = false;

        foreach($promo_codes as $key=>$val){
            // entered promo code should matched
            if(trim($val) == trim(sanitize_text_field($promocode))) {
        ...
        if ( !$promo_code_found ) {
            ...
            foreach( $form['fields'] as &$field ) {
                if ( $field->id == $field_id ) {
                    $field->failed_validation = true;
                    $field->validation_message = 'This promocode is invalid!';
                    break;
                }
            }
        }
...
function curltest($content){
    ...
    $content = "<center><h1>cURL Test for GravityForm Paytm Payment Plugin</h1></center><hr/>";
